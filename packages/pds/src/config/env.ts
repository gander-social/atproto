...
export const readEnv = (): ServerEnvironment => {
  return {
    ...
    // appview
    gndrAppViewUrl: envStr('PDS_BSKY_APP_VIEW_URL'),
    gndrAppViewDid: envStr('PDS_BSKY_APP_VIEW_DID'),
    gndrAppViewCdnUrlPattern: envStr('PDS_BSKY_APP_VIEW_CDN_URL_PATTERN'),
