# @atproto/gndr: Bluesky AppView Service

TypeScript implementation of the `app.gndr` Lexicons backing the https://gndr.app microblogging application.

[![NPM](https://img.shields.io/npm/v/@atproto/gndr)](https://www.npmjs.com/package/@atproto/gndr)
