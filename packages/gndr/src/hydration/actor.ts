...
import { Record as ChatDeclarationRecord } from '../lexicon/types/chat/gndr/actor/declaration'
      ...
      const verifications = mapDefined(
        ...
        ([actorDid, verificationMeta]) => {
          if (
            ...
            return {
              issuer: actorDid,
              uri: `at://${actorDid}/app.gndr.graph.verification/${verificationMeta.rkey}`,
