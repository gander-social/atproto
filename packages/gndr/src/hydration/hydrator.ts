...
import { isMain as isEmbedRecord } from '../lexicon/types/app/gndr/embed/record'
...
export class Hydrator {
  ...
  // app.gndr.actor.defs#profileView
  // - profile viewer
  //   - list basic
  ...
  // app.gndr.actor.defs#profileViewBasic
  // - profile basic
  //   - profile
  //     - list basic
  ...
  // app.gndr.actor.defs#profileViewDetailed
  // - profile detailed
  //   - profile
  //     - list basic
  //   - starterpack
  ...
  // app.gndr.graph.defs#listViewBasic
  // - list basic
  ...
  // app.gndr.graph.defs#listItemView
  // - list item
  //   - profile
  //     - list basic
...
const isModList = (
  ...
  return list?.record.purpose === 'app.gndr.graph.defs#modlist'
}
