...
} from '../lexicon/types/app/gndr/feed/post'
...
import { Record as FollowRecord } from '../lexicon/types/app/gndr/graph/follow'
import { Record as VerificationRecord } from '../lexicon/types/app/gndr/graph/verification'
import {
  LabelerView,
  LabelerViewDetailed,
} from '../lexicon/types/app/gndr/labeler/defs'
import {
  Record as LabelerRecord,
  isRecord as isLabelerRecord,
} from '../lexicon/types/app/gndr/labeler/service'
import { RecordDeleted as NotificationRecordDeleted } from '../lexicon/types/app/gndr/notification/defs'
import { ThreadHiddenItem } from '../lexicon/types/app/gndr/unspecced/getPostThreadHiddenV2'
import {
  QueryParams as GetPostThreadV2QueryParams,
  ThreadItem,
} from '../lexicon/types/app/gndr/unspecced/getPostThreadV2'
...
const notificationDeletedRecord = {
  $type: 'app.gndr.notification.defs#recordDeleted' as const,
}
...
export class Views {
  ...
  private threadV2ItemPost({
    ...
    return {
      ...
      depth,
      value: {
        $type: 'app.gndr.unspecced.getPostThreadV2#threadItemPost',
        post: postView,
  ...
  private threadV2ItemNoUnauthenticated({
    ...
    return {
      ...
      depth,
      value: {
        $type: 'app.gndr.unspecced.getPostThreadV2#threadItemNoUnauthenticated',
      },
    }
  }
  ...
  private threadV2ItemNotFound({
    ...
    return {
      ...
      depth,
      value: {
        $type: 'app.gndr.unspecced.getPostThreadV2#threadItemNotFound',
      },
    }
  }
  ...
  private threadV2ItemBlocked({
    ...
    return {
      ...
      depth,
      value: {
        $type: 'app.gndr.unspecced.getPostThreadV2#threadItemBlocked',
        author: {
          did: authorDid,
          viewer: this.blockedProfileViewer(authorDid, state),
        },
  ...
  private threadHiddenV2ItemPost({
    ...
    return {
      ...base,
      value: {
        $type: 'app.gndr.unspecced.getPostThreadHiddenV2#threadHiddenItemPost',
        post: postView,
        hiddenByThreadgate,
        mutedByViewer,
      },
